...
Cal.prototype.showMonth = function(y, m) {
    ...
    html += '<thead><tr>';
    // html += '<td><button id="btnPrev" type="button"><</button></td>';
    html += '<td colspan="7">' + this.Months[m].toLowerCase() + ' ' + y + '</td>';
    // html += '<td><button id="btnNext" type="button">></button></td>';
    html += '</tr></thead>';
        ...
        <div class="modal_body">
            <div class="fields">
                <form>
                    ...
                    <input type="button" value="сохранить изменения" class="button button_main">
                </form>
            </div>
        </div>
    </div>
