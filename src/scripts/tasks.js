...
function addListElement(){
    ...
    li.innerHTML = `
    <form class="list_element" id="list_element_${iterator}">
        <div class="checked">
        ...
        <img class="trashBox" src="../src/images/trash.png" alt="Трэш" onclick="deleteListElement('list_element_${iterator}')"/>
    </form>
    `;
    ul.appendChild(li);
    iterator++;
...
function deleteListElement(list_element){
    console.log(list_element);
    let el = document.getElementById(list_element);
    el.remove();
}